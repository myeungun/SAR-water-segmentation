...
def inference(img):
    ...
    with tf.compat.v1.variable_scope("inference"):
        ...
        conv3_3 = tf.layers.conv2d(conv3_2, 256, 3, activation=tf.nn.relu, padding='same',
            kernel_initializer=tf.contrib.layers.xavier_initializer())
        conv3_4 = tf.layers.conv2d(conv3_3, 256, 3, activation=tf.nn.relu, padding='same',
                                   kernel_initializer=tf.contrib.layers.xavier_initializer())
        pool3 = tf.layers.max_pooling2d(conv3_4, pool_size=2, strides=2, padding='same')
        ...
        conv4_3 = tf.layers.conv2d(conv4_2, 512, 3, activation=tf.nn.relu, padding='same',
            kernel_initializer=tf.contrib.layers.xavier_initializer())
        conv4_4 = tf.layers.conv2d(conv4_3, 512, 3, activation=tf.nn.relu, padding='same',
            kernel_initializer=tf.contrib.layers.xavier_initializer())
        pool4 = tf.layers.max_pooling2d(conv4_4, pool_size=2, strides=2, padding='same')
        ...
        conv5_3 = tf.layers.conv2d(conv5_2, 512, 3, activation=tf.nn.relu, padding='same',
            kernel_initializer=tf.contrib.layers.xavier_initializer())
        conv5_4 = tf.layers.conv2d(conv5_3, 512, 3, activation=tf.nn.relu, padding='same',
            kernel_initializer=tf.contrib.layers.xavier_initializer())
        pool5 = tf.layers.max_pooling2d(conv5_4, pool_size=2, strides=2, padding='same')

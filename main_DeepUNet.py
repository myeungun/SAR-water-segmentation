...
def main(_):
    ...
    train_model = DeepUNet.inference(image)
...
if __name__ == '__main__':
    ...
    tf.flags.DEFINE_string("weight_dir", "./weight_DeepUNet", "weight_FCN_VGG16 directory.")
    tf.flags.DEFINE_string("weight_FCN_VGG16", "DeepUNet", "the latest weight_FCN_VGG16 saved.")
    ...
    tf.flags.DEFINE_string("result", "./data/val/result_DeepUNet", "path for validation result.")

...
def main(_):
    ...
    train_model = FCN_VGG19.inference(image)
...
if __name__ == '__main__':
    ...
    tf.flags.DEFINE_string("weight_dir", "./weight_FCN_VGG19", "weight_FCN_VGG16 directory.")
    tf.flags.DEFINE_string("weight_FCN_VGG16", "FCN-VGG19", "the latest weight_FCN_VGG16 saved.")
    ...
    tf.flags.DEFINE_string("result", "./data/val/result_FCN_VGG19", "path for validation result.")
